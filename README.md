...
Check the [releases](https://github.com/droboports/python-lxml/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/python-lxml.git
cd python-lxml
./build.sh
ls -la *.egg
```
